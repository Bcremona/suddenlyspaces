...
export default function PropertyCard({ property }) {
  ...
  return (
    ...
    <div className="rounded-lg p-4 shadow-md shadow-gray-400 m-2 flex flex-row hover:scale-105 hover:shadow-lg hover:shadow-gray-400 transition-all bg-white">
      ...
      <div>
        ...
        {user.role === "landlord" && user.id === property.landlordId && (
          <>
          <Link to={`/properties/edit/${property.id}`} className="text-white bg-sky-700 hover:bg-sky-600 hover:scale-110 transition-all px-3 py-1 rounded-md mr-2 inline-block mt-2">
            Edit Property
          </Link>
